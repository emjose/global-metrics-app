    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <div>
          ...
          <div className={styles.buttoncontainer}>
            <button className={styles.themeSwitcher} onClick={switchTheme} tabIndex="0" style={{ cursor: "pointer" }}>
      ...
      <footer className={styles.footer}>
        <Link href="https://github.com/emjose" target="_blank" rel="noopener noreferrer">
          <a>
            Made by Emmanuel Jose
          </a>
        </Link>
        &nbsp;•&nbsp;
        <Link href="https://github.com/emjose/global-metrics-app/#header" target="_blank" rel="noopener noreferrer">
          <a>
            View Github
          </a>
        </Link>
